...
const DEFAULT_CMS_PAGES = [
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        heading: 'Every piece is made by hand. No two are ever the same.',
      },
      {
        type: 'collection_banner',
        eyebrow: 'The Collection',
        heading: 'Every piece has a story to tell',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    title: 'FAQ',
    blocks: [
      { type: 'faq_item', question: 'How do I place an order?', answer: 'Add pieces to your cart, then send the request by WhatsApp or email. We confirm availability, shipping, and payment before the order is final.' },
      ...
      { type: 'faq_item', question: 'How long does shipping take?', answer: 'Ready-to-ship orders usually leave within 5–7 business days after payment. Custom timelines are confirmed separately.' },
      ...
      { type: 'faq_item', question: 'Are your pieces food safe?', answer: 'Yes. All glazes used on our functional pieces (cups, bowls, plates, jars) are food-safe and lead-free. Decorative pieces like tiles are for display only.' },
      { type: 'faq_item', question: 'How should I care for my ceramics?', answer: 'Hand washing is recommended. Avoid sudden temperature changes, and check each product page for specific use notes.' },
      { type: 'faq_item', question: 'Can I request a custom piece?', answer: 'Yes. Send your idea by email or WhatsApp, and we will confirm scope, price, and timing before work begins.' },
      { type: 'faq_item', question: 'What if my piece arrives damaged?', answer: 'Contact us within 48 hours with photos. Because each piece is unique, we may refund, repair, or discuss a close alternative rather than send an identical replacement.' },
      { type: 'faq_item', question: 'Are pieces exactly like the photos?', answer: 'Each piece is handmade and one-of-a-kind. Product photos represent the listed piece as accurately as possible.' },
      { type: 'faq_item', question: 'Do you do wholesale?', answer: 'We work with select shops and galleries. Contact us to discuss availability.' },
    ],
  },
  {
    slug: 'terms',
    ...
    title: 'Terms',
    blocks: [
      { type: 'terms_section', title: 'Orders', body: 'Cart checkout sends an order request. An order is confirmed only after we confirm availability, shipping cost, payment details, and any relevant timing.' },
      { type: 'terms_section', title: 'Unique Pieces', body: 'Each ceramic piece is handmade and one-of-a-kind. Small differences in colour, size, glaze, and texture are part of the work. Product photos represent the listed piece as accurately as possible.' },
      ...
      { type: 'terms_section', title: 'Custom Work', body: 'Custom pieces are agreed individually. Scope, price, payment terms, and estimated timing must be confirmed before work begins.' },
      ...
      { type: 'terms_section', title: 'Returns', body: 'For eligible distance purchases, contact us within 14 days of delivery before returning an item. Custom or clearly personalised pieces are not returnable unless faulty or damaged. These terms do not limit any statutory consumer rights that apply to your order.' },
    ],
  },
  {
    ...
    blocks: [
      ...
      { type: 'nav_link', order: 3, href: '/about', label: 'About' },
      { type: 'nav_link', order: 4, href: '/contact', label: 'Contact' },
      { type: 'nav_link', order: 5, href: '/faq', label: 'FAQ' },
      { type: 'nav_link', order: 6, href: '/account', label: 'My Account' },
    ],
  },
  {
    slug: 'account',
