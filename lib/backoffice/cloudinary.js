...
const DEFAULT_UPLOAD_FOLDER = 'atelier/products';
const DEFAULT_MAX_UPLOAD_MB = 5;
const DEFAULT_FALLBACK_IMAGE = '/images/placeholder-top.svg';
...
export async function uploadProductImageToCloudinary(file, metadata = {}) {
  ...
  const result = await uploadBuffer(buffer, {
    ...
    overwrite: false,
    tags: ['atelier', 'product', productTag].filter(Boolean),
    context: {
      source: 'atelier-backoffice',
